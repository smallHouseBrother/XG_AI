...
@interface IAPPurchaseInfo() <SKPaymentTransactionObserver, SKProductsRequestDelegate>
{
...
static IAPPurchaseInfo * manager = nil;

@implementation IAPPurchaseInfo
...
+ (instancetype)manager
{
    ...
    dispatch_once(&onceToken, ^{
        if (!manager) {
            manager = [[IAPPurchaseInfo alloc] init];
        }
    });
    return manager;
}

...
- (UIViewController *)cw_getRootViewControllerWithDrewerHiddenDuration:(NSTimeInterval)duration
{
    if (duration > 0) {
        CWLateralSlideAnimator *animator = (CWLateralSlideAnimator *)self.transitioningDelegate;
        animator.configuration.HiddenAnimDuration = duration;
    ...
    return [[UIApplication sharedApplication].keyWindow.rootViewController.childViewControllers firstObject];
}
